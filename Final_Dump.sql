...
--
-- Temporary view structure for view `avg_restaurant_rating`
--

DROP TABLE IF EXISTS `avg_restaurant_rating`;
/*!50001 DROP VIEW IF EXISTS `avg_restaurant_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `avg_restaurant_rating` AS SELECT 
 1 AS `avg(overall_rating)`,
...
CREATE TABLE `delivery_rating` (
  ...
  `courteous` tinyint(1) NOT NULL,
  PRIMARY KEY (`rating_id`),
  CONSTRAINT `fk_1_rating_id` FOREIGN KEY (`rating_id`) REFERENCES `ratings` (`rating_id`)
...
INSERT INTO `delivery_rating` VALUES (1,1,1),(2,1,1),(3,1,1),(4,0,1),(5,1,0),(6,0,1),(7,0,1),(8,1,0),(9,1,1),(10,0,1),(11,1,1),(12,1,0),(13,1,0),(14,0,1),(15,0,1),(16,0,1),(17,1,1),(18,1,1),(19,1,1),(20,1,1);
...
--
-- Temporary view structure for view `driver_rating`
--

DROP TABLE IF EXISTS `driver_rating`;
/*!50001 DROP VIEW IF EXISTS `driver_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driver_rating` AS SELECT 
 1 AS `driver_id`,
 1 AS `date_hired`,
 1 AS `avg_rating`,
 1 AS `order_id`,
...
CREATE TABLE `ratings` (
  ...
  CONSTRAINT `fk_O_order_id` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ratings` VALUES (1,5,1),(2,8,2),(3,7,3),(4,3,4),(5,6,5),(6,9,6),(7,9,7),(8,1,8),(9,6,9),(10,10,10),(11,3,11),(12,7,12),(13,9,13),(14,8,14),(15,7,15),(16,2,16),(17,5,17),(18,2,18),(19,8,19),(20,9,20);
...
--
-- Table structure for table `resturant_rating`
--

DROP TABLE IF EXISTS `resturant_rating`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `resturant_rating` (
  `rating_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `resturant_rating`
--

LOCK TABLES `resturant_rating` WRITE;
/*!40000 ALTER TABLE `resturant_rating` DISABLE KEYS */;
INSERT INTO `resturant_rating` VALUES (1,7,5),(2,7,7),(3,10,2),(4,4,10),(5,7,1),(6,9,8),(7,10,3),(8,2,2),(9,1,2),(10,10,3),(11,2,8),(12,4,5),(13,7,6),(14,5,8),(15,10,8),(16,7,8),(17,6,8),(18,9,10),(19,2,8),(20,6,10);
/*!40000 ALTER TABLE `resturant_rating` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Final view structure for view `avg_restaurant_rating`
--
...
/*!50001 VIEW `avg_restaurant_rating` AS select avg(`ra`.`overall_rating`) AS `avg(overall_rating)`,`re`.`restaurant_name` AS `restaurant_name` from ((`ratings` `ra` join `orders` `o` on((`o`.`order_id` = `ra`.`order_id`))) join `restaurant` `re` on((`re`.`restaurant_id` = `o`.`restaurant_id`))) group by `o`.`restaurant_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `driver_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `driver_rating` AS select `d`.`driver_id` AS `driver_id`,`d`.`date_hired` AS `date_hired`,avg(`d`.`rating`) AS `avg_rating`,`o`.`order_id` AS `order_id`,(case when (`d`.`rating` > avg(`d`.`rating`)) then 'Excellent' when (`d`.`rating` = avg(`d`.`rating`)) then 'Good' else 'Poor' end) AS `Performance` from ((select `driver`.`driver_id` AS `driver_id`,`driver`.`date_hired` AS `date_hired`,`driver`.`rating` AS `rating` from `driver`) `d` join `orders` `o` on((`d`.`driver_id` = `o`.`driver_id`))) group by `o`.`order_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-05-05 16:18:59
